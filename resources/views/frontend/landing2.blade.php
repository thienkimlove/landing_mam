...
<head>
    ...
    <link href="{{url('frontend/css/ldg-sam-to-nu.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <script src="{{url('frontend/js/ldg-sam-to-nu.js')}}" type="text/javascript"></script>
</head>
<body>
<div class='all-page'>
    <section class='box-header'>
        ...
        <div class='container'>
            <div class='thumb-mobile'>
                <img src="{{url('frontend/images/landingpage-sam-to-nu/bg-header.jpg')}}" alt=""/>
            </div>
            <p class='logo'>
                <img src="{{url('frontend/images/landingpage-sam-to-nu/logo-mam.png')}}" alt=""/>
            </p>
            <div class='list-item'>
                <h2>Bổ sung sâm tố nữ X5 hiệu quả</h2>
                <ul>
    ...
    <section class="box-ldg-2">
        <div class='container'>
            <div class='row'>
                <div class='col-md-6'>
                    <h3>Tác dụng</h3>
                    <h4>tăng vòng ngực diệu kỳ từ</h4>
                    <h2>Sâm tố nữ</h2>
                    <div class='img'>
                        <img src="{{url('frontend/images/landingpage-sam-to-nu/bg-box-2.png')}}" alt=""/>
                    </div>
                </div>
                <div class='col-md-6'>
                    <div class="list-item">
                        <div class="item">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniamUt enim ad minim veniam.
                        </div>
                        <div class="item">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniamUt enim ad minim veniam.
                        </div>
    ...
    <footer>
        <div class="container">
            <div class='thumb-mobile'>
                <img src="{{url('frontend/images/landingpage-sam-to-nu/bg-footer.jpg')}}" alt=""/>
            </div>
            <div class='buy'>
                <div class='readmore'><a href='{{url('lien-he')}}' title="Mua ngay"></a></div>
                <div class='price'>Giá 495,000đ/hộp</div>
            </div>
        </div>
    </footer>
